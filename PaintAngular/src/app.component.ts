...
export class AppComponent {
  ...
  Undo = false;
	...
	scalePoints(shape: IShape){
		...
		// this.tr.rotateAnchorOffset(0);
		
		//, 'top-center', , 'middle-right', 'middle-left', 'bottom-left', 'bottom-center', 'bottom-right'
		let anchor = this.SelectedItem.findOne('.' + this.tr.getActiveAnchor());
		console.log( "scalePoints Fn : " + anchor.absolutePosition() );
