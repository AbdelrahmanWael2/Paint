...
//    private String error = "error";
    ...
    public shapeClass(String name, String id, double xP, double yP, double x, double y, String border, double borderWidth, boolean borderScaleEnabled, String fill, boolean fillEnabled, double rotation, double[] points) {
        Name = name;
        this.id = id;
        this.xP = xP;
        this.yP = yP;
    ...
    public shapeClass clone(){
        shapeClass another = new shapeClass(Name, id, xP, yP, x, y, border, borderWidth, borderScaleEnabled, fill, fillEnabled, rotation, points);
        return another;
    }
