...
public class Square extends shapeClass {
    ...
    public Square() {
        super("square", "", 0.0, 0.0, 70.0, 70.0, "black", 5.0, false, "white", false, 0.0,
                new double[] { 0.0, 0.0, 100.0, 0.0 });
    }

    public Square(String name, String id, double xP, double yP, double x, double y, String border,
            double borderWidth,
    ...
    public shapeClass clone() {
        shapeClass another = new Square(getName(), getId(), getxP(), getyP(), getX(), getY(), getBorder(),
