...
public class shapeClass implements IShape {
    ...
    public shapeClass clone() {
        shapeClass another = new shapeClass(Name, id, xP, yP, x, y, border, borderWidth, borderScaleEnabled, fill,
    ...
    public boolean compareTo(shapeClass obj) {
        ...
        return (Name.equals(obj.getName())) && (id.equals(obj.getId())) && (xP == obj.getxP()) && (yP == obj.getyP())
                ...
                && (borderScaleEnabled == obj.isBorderScaleEnabled()) && (fill.equals(obj.getFill()))
                && fillEnabled == obj.isFillEnabled() && (rotation == obj.getRotation());
    }
